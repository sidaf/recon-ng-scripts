...
class Module(BaseModule):
    ...
    meta = {
        ...
        'options': (
            ('limit', 0, True, 'limit number of api requests per input source (0 = unlimited)'),
        ),
    }
        ...
        for ipaddr in ipaddrs:
            ...
            for host in results:
                ...
                for hostname in host['hostnames']:
                    self.add_ports(ip_address=address, port=port, protocol=protocol, host=hostname)
